# Dell Power Edge R730 (Intel Haswell/Broadwell)
 ...
 * Supports PCI-express SSDs mounted in the front disk bays. These do not require a RAID card. 
...
R730 always ships with one of the following NIC daughercards:
 - 4 x 1Gb RJ45 ports, Intel or broadcom
 - 2 x 10Gb SFP+ ports and 2 x 1Gb RJ45 ports, Intel or Broadcom
 - 2 x 10Gb RJ45 and 2 x 1Gb RJ45 ports, Intel or Broadcom
 ...
 * Intel/Qlogic Omnipath QDR Infiniband PCI-express and mez HCA
 ...
 * Nvidia passive GPUs (Tesla series) and Xeon Phi add-in cards up to 335W; does not support active GPU cards
 ...
 * Does not support consumer grade GPUs with fans
 * Mellanox Infiniband cards usually ship with Ethernet-only firmware installed if they are factory-fitted
 * 12-drive 3.5" and 24-drive 2.5" chassis have no iDRAC LCD display